...
describe EventosController do
  ...
  let(:valid_attributes) { { "lugar" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved evento as @evento" do
        ...
        post :create, {:evento => { "lugar" => "invalid value" }}, valid_session
        assigns(:evento).should be_a_new(Evento)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested evento" do
        ...
        Evento.any_instance.should_receive(:update).with({ "lugar" => "MyString" })
        put :update, {:id => evento.to_param, :evento => { "lugar" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the evento as @evento" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Evento.any_instance.stub(:save).and_return(false)
        put :update, {:id => evento.to_param, :evento => { "lugar" => "invalid value" }}, valid_session
        assigns(:evento).should eq(evento)
      end
